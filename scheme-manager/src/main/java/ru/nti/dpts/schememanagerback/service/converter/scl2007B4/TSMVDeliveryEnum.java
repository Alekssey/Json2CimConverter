...
/**
 * <p>Java class for tSMVDeliveryEnum.
 * 
...
public enum TSMVDeliveryEnum {
    ...
    public static TSMVDeliveryEnum fromValue(String v) {
        for (TSMVDeliveryEnum c: TSMVDeliveryEnum.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
