    ...
    extends TControlWithIEDName
{
    ...
    @XmlAttribute(name = "smpMod")
    protected TSmpMod smpMod;
    ...
    public static class SmvOpts {
        ...
        @XmlAttribute(name = "synchSourceId")
