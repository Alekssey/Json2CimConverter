...
object ShortCircuitOps : EquipmentOps(EquipmentLibId.SHORT_CIRCUIT) {
    override fun createControlsWithDefaultValuesAndBounds(fields: Map<FieldLibId, String?>):
        Map<ControlLibId, ControlDto> {
        return mapOf(
            createControlWithDefaultValueAndNanBounds(ControlLibId.FAULT),
            createControlWithDefaultValueAndNanBounds(ControlLibId.SHORT_CIRCUIT_TYPE),
