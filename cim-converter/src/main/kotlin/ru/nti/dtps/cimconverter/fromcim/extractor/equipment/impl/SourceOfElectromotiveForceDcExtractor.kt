...
object SourceOfElectromotiveForceDcExtractor : SealedEquipmentExtractor() {

    private val cimClass = DtpsClasses.DcEmfSource
    private val equipmentLibId = EquipmentLibId.SOURCE_OF_ELECTROMOTIVE_FORCE_DC
    ...
    override fun extract(
        ...
        equipments = create(
            repository.selectAllVarsFromTriples(
                ...
                cimClass.emfPhaseB,
                cimClass.emfPhaseC,
                cimClass.resistancePhaseA,
                cimClass.resistancePhaseB,
                cimClass.resistancePhaseC
            ),
            substations,
            lines,
            baseVoltages,
    ...
    private fun create(
        ...
        RawEquipmentCreator.equipmentWithBaseData(
            ...
            FieldLibId.ELECTROMOTIVE_FORCE_PHASE_A to bindingSet.extractDoubleValueOrNull(cimClass.emfPhaseA),
            FieldLibId.ELECTROMOTIVE_FORCE_PHASE_B to bindingSet.extractDoubleValueOrNull(cimClass.emfPhaseB),
            FieldLibId.ELECTROMOTIVE_FORCE_PHASE_C to bindingSet.extractDoubleValueOrNull(cimClass.emfPhaseC),
            FieldLibId.RESISTANCE_PHASE_A to bindingSet.extractDoubleValueOrNull(cimClass.resistancePhaseA),
            FieldLibId.RESISTANCE_PHASE_B to bindingSet.extractDoubleValueOrNull(cimClass.resistancePhaseB),
            FieldLibId.RESISTANCE_PHASE_C to bindingSet.extractDoubleValueOrNull(cimClass.resistancePhaseC)
        )
    }
}
