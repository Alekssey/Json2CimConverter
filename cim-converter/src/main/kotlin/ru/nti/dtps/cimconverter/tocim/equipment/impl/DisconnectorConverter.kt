...
object DisconnectorConverter : AbstractEquipmentConversion() {
    override fun convert(
        ...
        val resource = RdfResourceBuilder(equipment.id, CimClasses.Disconnector)
    ...
    private fun defineTerminalPhaseCode(
        ...
        EquipmentLibId.DISCONNECTOR_1PH -> CimClasses.PhaseCode.A
