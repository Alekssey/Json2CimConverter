...
object ReactivePowerCompensatorSystemExtractor : SealedEquipmentExtractor() {

    private val cimClass = CimClasses.ShuntCompensator
    private val equipmentLibId = EquipmentLibId.REACTIVE_POWER_COMPENSATION_SYSTEM
    ...
    override fun extract(
        ...
        equipments = create(
            repository.selectAllVarsFromTriples(
                ...
                CimClasses.ShuntCompensator.nomU,
                CimClasses.ShuntCompensator.aVRDelay,
                CimClasses.StaticVarCompensator.q,
                CimClasses.StaticVarCompensator.voltageSetPoint,
                CimClasses.StaticVarCompensator.slope,
                DtpsClasses.StaticVarCompensator.q,
                DtpsClasses.StaticVarCompensator.tU
            ),
            substations,
            lines,
            baseVoltages,
    ...
    private fun create(
        ...
        RawEquipmentCreator.equipmentWithBaseData(
            ...
            FieldLibId.RATED_VOLTAGE_LINE_TO_LINE to bindingSet.extractDoubleValueOrNull(CimClasses.ShuntCompensator.nomU),
            FieldLibId.DRIVING_SYSTEM_TIME_CONSTANT to bindingSet.extractDoubleValueOrNull(CimClasses.ShuntCompensator.aVRDelay),
            FieldLibId.RATED_REACTIVE_POWER_OF_CAPACITOR_BANK to bindingSet.extractDoubleValueOrNull(CimClasses.StaticVarCompensator.q),
            FieldLibId.VOLTAGE_SETPOINT to bindingSet.extractDoubleValueOrNull(CimClasses.StaticVarCompensator.voltageSetPoint),
            FieldLibId.GAIN to bindingSet.extractDoubleValueOrNull(CimClasses.StaticVarCompensator.slope),
            FieldLibId.RATED_REACTIVE_POWER_OF_REACTOR to bindingSet.extractDoubleValueOrNull(DtpsClasses.StaticVarCompensator.q),
            FieldLibId.INTEGRATION_TIME_CONSTANT to bindingSet.extractDoubleValueOrNull(DtpsClasses.StaticVarCompensator.tU)
