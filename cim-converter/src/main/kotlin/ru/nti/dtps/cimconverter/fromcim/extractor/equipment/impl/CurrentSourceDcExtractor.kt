...
object CurrentSourceDcExtractor : SealedEquipmentExtractor() {

    private val cimClass = DtpsClasses.DcCurrentSource
    private val equipmentLibId = EquipmentLibId.CURRENT_SOURCE_DC
    ...
    override fun extract(
        ...
        equipments = create(
            repository.selectAllVarsFromTriples(
                ...
                cimClass.currentPhaseA,
                cimClass.currentPhaseB,
                cimClass.currentPhaseC,
                cimClass.conductivityPhaseA,
                cimClass.conductivityPhaseB,
                cimClass.conductivityPhaseC
            ),
            substations,
            lines,
            baseVoltages,
    ...
    private fun create(
        ...
        RawEquipmentCreator.equipmentWithBaseData(
            ...
            FieldLibId.CONDUCTIVITY_PHASE_A to bindingSet.extractDoubleValueOrNull(cimClass.conductivityPhaseA),
            FieldLibId.CONDUCTIVITY_PHASE_B to bindingSet.extractDoubleValueOrNull(cimClass.conductivityPhaseB),
            FieldLibId.CONDUCTIVITY_PHASE_C to bindingSet.extractDoubleValueOrNull(cimClass.conductivityPhaseC),
            FieldLibId.CURRENT_PHASE_A to bindingSet.extractDoubleValueOrNull(cimClass.currentPhaseA),
            FieldLibId.CURRENT_PHASE_B to bindingSet.extractDoubleValueOrNull(cimClass.currentPhaseB),
            FieldLibId.CURRENT_PHASE_C to bindingSet.extractDoubleValueOrNull(cimClass.currentPhaseC)
        )
    }
}
