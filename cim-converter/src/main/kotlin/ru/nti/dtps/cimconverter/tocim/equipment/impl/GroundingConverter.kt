...
object GroundingConverter : AbstractEquipmentConversion() {
    override fun convert(
        ...
        val resource = RdfResourceBuilder(equipment.id, CimClasses.Ground)
    ...
    private fun defineTerminalPhaseCode(
        ...
        EquipmentLibId.GROUNDING_1PH -> CimClasses.PhaseCode.A
