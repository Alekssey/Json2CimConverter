...
object CurrentSourceDc1PhExtractor : SealedEquipmentExtractor() {

    private val cimClass = DtpsClasses.DcCurrentSourceByPhase
    private val equipmentLibId = EquipmentLibId.CURRENT_SOURCE_DC_1PH
    ...
    private fun create(
        ...
        RawEquipmentCreator.equipmentWithBaseData(
            ...
            FieldLibId.CONDUCTIVITY to bindingSet.extractDoubleValueOrNull(DtpsClasses.DcCurrentSourceByPhase.conductivity),
            FieldLibId.CURRENT to bindingSet.extractDoubleValueOrNull(DtpsClasses.DcCurrentSourceByPhase.current)
        )
    }
}
