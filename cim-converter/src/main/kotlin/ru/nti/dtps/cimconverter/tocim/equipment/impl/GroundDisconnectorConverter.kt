...
object GroundDisconnectorConverter : AbstractEquipmentConversion() {
    override fun convert(
        ...
        val resource = RdfResourceBuilder(equipment.id, CimClasses.GroundDisconnector)
    ...
    private fun defineTerminalPhaseCode(
        ...
        EquipmentLibId.GROUND_DISCONNECTOR_1PH -> CimClasses.PhaseCode.A
