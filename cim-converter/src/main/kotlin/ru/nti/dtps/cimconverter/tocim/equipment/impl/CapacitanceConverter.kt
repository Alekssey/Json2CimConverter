...
object CapacitanceConverter : AbstractEquipmentConversion() {
    override fun convert(
        ...
        val resource = RdfResourceBuilder(equipment.id, DtpsClasses.Capacitance)
    ...
    private fun defineTerminalPhaseCode(
        ...
        EquipmentLibId.CAPACITANCE_1PH -> CimClasses.PhaseCode.A
