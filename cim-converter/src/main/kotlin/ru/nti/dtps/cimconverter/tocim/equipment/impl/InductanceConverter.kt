...
object InductanceConverter : AbstractEquipmentConversion() {
    override fun convert(
        ...
        val resource = RdfResourceBuilder(equipment.id, DtpsClasses.Inductance)
    ...
    private fun defineTerminalPhaseCode(
        ...
        EquipmentLibId.INDUCTANCE_1PH -> CimClasses.PhaseCode.A
