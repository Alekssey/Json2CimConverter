...
object VoltageTransformerExtractor : SealedEquipmentExtractor() {

    private val cimClass = CimClasses.PotentialTransformer
    private val equipmentLibId = EquipmentLibId.VOLTAGE_TRANSFORMER
    ...
    private fun create(
        ...
        RawEquipmentCreator.equipmentWithBaseData(
            ...
            FieldLibId.FIRST_WINDING_RATED_VOLTAGE to bindingSet
                .extractDoubleValueOrNull(DtpsClasses.PotentialTransformer.primaryWindingRatedVoltage),
            FieldLibId.SECOND_WINDING_RATED_VOLTAGE to bindingSet
                .extractDoubleValueOrNull(DtpsClasses.PotentialTransformer.secondaryWindingRatedVoltage)
        )
    }
}
